...
import { deleteReminder, getAppointments, getAssignedDoctors, getPatientInfo, getPrescribedMedications, getReminders, logoutUser } from '../services/api';
            ...
            <Card sx={{ height: '100%', borderRadius: 2 }}>
              <CardContent>
                ...
                <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
                  <Button variant="outlined" startIcon={<AddAlertIcon />} onClick={() => { navigate('/create-reminder-form'); }}>
                    Add Reminder
                  </Button>
                  <Button variant="outlined" startIcon={<EventAvailableIcon />} onClick={() => { navigate('/appointments'); }}>
                    Appointments
                  </Button>
                  <Button variant="outlined" startIcon={<PersonSearchIcon />} onClick={() => { navigate('/doctor-search'); }}>
                    Search Doctors
                  </Button>
                  <Button variant="outlined" startIcon={<ManageAccountsIcon />} onClick={() => { navigate('/patient-settings'); }}>
                    Patient Settings
                  </Button>
                  <Button variant="outlined" color="error" startIcon={<LogoutIcon />} onClick={async () => { try { await logoutUser(); } finally { 
