                ...
                <Card sx={{ width: "100%", p: { xs: 2, md: 3 }, border: "1px solid", borderColor: "divider" }}>
                    <CardContent sx={{ p: 0, "&:last-child": { pb: 0 } }}>
                        ...
                        <Stack spacing={3}>
                            ...
                            {/* Medication Dropdown */}
                            <Box>
                            <Typography variant="h6" sx={{ fontWeight: 400, mb: 0.5 }}>Select Medication</Typography>
                            ...
                            <Box>
                            <Typography variant="h6" sx={{ fontWeight: 400, mb: 0.5 }}>Reminder Title</Typography>
                            ...
                            {/* Frequency Display */}
                            <Box>
                                <Typography variant="h6" sx={{ fontWeight: 400, mb: 1.2 }}>Frequency</Typography>
                            ...
                            <Box>
                                <Typography variant="h6" sx={{ fontWeight: 400, mb: 1.2 }}>Schedule</Typography>
                            ...
                            <Box>
                                <Typography variant="h6" sx={{ fontWeight: 400, mb: 1.2 }}>Reminder Times</Typography>
                                ...
                                <Box sx={{ display: "flex", flexWrap: "wrap", gap: 1, alignItems: "center" }}>
                                    ...
                                    <Button
                                        ...
                                        disabled={
                                            !selectedMedication ||
                                            loadingMedications || loadingPatient ||
                                        ...
                                        sx={{ height: 32, whiteSpace: 'nowrap', bgcolor: '#565656', color: '#ffffff', '&:hover': { bgcolor: '#999999' } }}
                                    >
                                        + Add Time
                                    </Button>
